  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for pilots and experimentation.",
      features: [
        "Real-time voice insights",
        "Basic integrations",
        "Single voice pipeline",
        "Up to 2 voice agents",
        "IndusLabs-branded deployments",
      ],
    ...
    },
    {
      ...
      features: [
        "Advanced live call monitoring",
        "Unlimited enterprise integrations",
        "Multiple voice pipelines",
        "Up to 10 concurrent voice agents",
    ...
    },
    {
      ...
      monthlyPrice: "$200",
      annualPrice: "$160",
      description: "Enterprise-grade voice AI at scale.",
      features: [
        "Dedicated account support",
        "Unlimited voice pipelines",
        "Unlimited voice agents",
        "Enterprise-grade security and compliance",
        "Dedicated SLAs and priority deployments",
      ],
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your voice automation needs, from pilots to enterprise scale.
          </p>
        </div>
        <div className="pt-4">
